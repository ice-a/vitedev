  ...
  <div class="about">
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item hello">
        ...
        <span class="text2 title2">我是 爱喝水的木子</span>
        <span class="text3">是一名 全干工程师</span>
      </div>
      <!-- 追求 -->
    ...
    <div class="about-content" style="grid-template-columns: 2fr 3fr">
      ...
      <div class="about-item career">
        ...
        <div class="list">
          <span class="list-item" style="--color: #eb372a">全干工程师</span>
        </div>
        <img
          class="career-img"
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item character" style="--color: #4298b4">
        ...
        <img
          src="https://api.lolimi.cn/API/meinv/api.php?type=image"
          alt="male"
          class="male"
        />
      </div>
    ...
    <div class="about-content" style="grid-template-columns: 1fr 1fr">
      ...
      >
        <div class="image-content">
          ...
          <span class="title2">粤语,民谣,陈奕迅,李宗盛</span>
          <div class="image-desc">
    ...
    <div class="about-content" style="grid-template-columns: 2fr 3fr">
      ...
      <div class="about-item child">
        ...
        >
          <span class="position">city <strong>中国，广东省，广州市，南沙区</strong></span>
        </div>
        <div class="about-item info">
          <div class="info-item">
            <span class="info-name">work</span>
            <span class="info-num" style="--color: #43a6c6">2019-???</span>
          </div>
          <!-- <div class="info-item">
            <span class="info-name">现在职业</span>
            <span class="info-num" style="--color: #dfac46">数据处理</span>
          </div> -->
        </div>
      </div>
      <div class="about-item child">
        <div
          class="about-item map image"
          style="background-image: url(https://t.mwm.moe/pc)"
        >
          <span class="position">city <strong>中国，河南省，南阳市</strong></span>
        </div>
        <div class="about-item info">
          <!-- <div class="info-item">
            <span class="info-name">生于</span>
            <span class="info-num" style="--color: #43a6c6">不祥</span>
          </div> -->
          <div class="info-item">
            <span class="info-name">现在职业</span>
            <span class="info-num" style="--color: #dfac46">啥都干工程师</span>
          </div>
        </div>
      </div>
    </div>
